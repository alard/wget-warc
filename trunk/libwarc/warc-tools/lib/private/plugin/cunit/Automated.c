...
void CU_set_output_filename(const char* szFilenameRoot)
{
  ...
  l = strlen(szListEnding);
  f_szTestListFileName[FILENAME_MAX - l - 1] = '\0';
  strncat(f_szTestListFileName, szListEnding, l);
  ...
  l = strlen(szResultEnding);
  f_szTestResultFileName[FILENAME_MAX - l - 1] = '\0';
  strncat(f_szTestResultFileName, szResultEnding, l);
}
